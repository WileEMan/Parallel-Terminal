// Taken from v4.6.1, I'm pretty sure.
...
namespace wbSystem.Diagnostics {
    using ThreadState = global::System.Diagnostics.ThreadState;
    ...
    // From reference source/mscorlib/system/monitoring/system/diagnosticts/processwaithandle.cs
    // And yeah there's a typo in "diagnosticts" spelling in the MS source.
    ...
    // From reference source/System/sys/system/EnvironmentHelpers.cs
    ...
    // From reference source v4.6.1/System/services/monitoring/system/diagnosticts/Process.cs
    // Modifications: SR string references replaced or removed.
    /// <devdoc>
    ///    <para>
    ...
    public class Process : Component
    {
        ...
        ///    </para>
        /// </devdoc>
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), MonitoringDescription("Returns the caption of the MainWindowHandle of the process.")]
        ...
        ///    </para>
        /// </devdoc>
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), MonitoringDescription("Gets the main module for the associated process.")]
        ...
        public ProcessPriorityClass PriorityClass
        {
            ...
            set
            {
                ...
                {
                    throw new PlatformNotSupportedException("Priority class not supported by platform.");
                }
        ...
        public StreamWriter StandardInput
        {
            get
            {
                ...
                {
                    throw new InvalidOperationException("Can't retrieve standard input");
                }
        ...
        public StreamReader StandardOutput
        {
            get
            {
                ...
                {
                    throw new InvalidOperationException("Can't retrieve standard output");
                }
                ...
                {
                    throw new InvalidOperationException("Can't mix synchronous and asynchronous operations");
                }
        ...
        public StreamReader StandardError
        {
            get
            {
                ...
                {
                    throw new InvalidOperationException("Can't retrieve standard error");
                }
        ...
        void EnsureState(State state)
        {
            ...
            if ((state & State.Associated) != (State)0)
                if (!Associated)
                    throw new InvalidOperationException("No associated process");
            ...
            if ((state & State.HaveId) != (State)0)
            {
                if (!haveProcessId)
                {
                    ...
                    {
                        EnsureState(State.Associated);
                        throw new InvalidOperationException("Process Id required");
                    }
#else
                    EnsureState(State.Associated);
            ...
            {
                throw new NotSupportedException("Not supported remote");
            }
            ...
            if ((state & State.HaveProcessInfo) != (State)0)
            {
                ...
                if (processInfo == null)
                {
                    ...
                    if (processInfo == null)
                    {
                        throw new InvalidOperationException("No process info");
                    }
                }
#else
            ...
            if ((state & State.Exited) != (State)0)
            {
                if (!HasExited)
                {
                    throw new InvalidOperationException("Wait till exit");
                }
        ...
        public static Process GetProcessById(int processId, string machineName)
        {
            ...
            {
                throw new ArgumentException("Missing process");
            }
                    ...
                    try
                    {
                        ...
                        if (waitHandle.WaitOne(0, false))
                        {
                            if (haveProcessId)
                                ...
                                throw new InvalidOperationException("Process has exited without id");
                        }
                    }
                    finally
                    {
        ...
        void SetWorkingSetLimits(object newMin, object newMax)
        {
            ...
            try
            {
                ...
                if ((long)min > (long)max)
                {
                    if (newMin != null)
                    {
                        throw new ArgumentException("Bad min workset");
                    }
                    else
                    {
                        throw new ArgumentException("Bad max workset");
                    }
                }
        ...
        public bool Start()
        {
            ...
            if (startInfo.FileName.Length == 0)
                throw new InvalidOperationException("File name missing");
        ...
        private bool StartWithCreateProcess(ProcessStartInfo startInfo)
        {
            ...
            {
                throw new InvalidOperationException("StandardOutput encoding is not allowed");
            }

            if (startInfo.StandardErrorEncoding != null && !startInfo.RedirectStandardError)
            {
                throw new InvalidOperationException("Standard error encoding is not allowed");
            }
        ...
        private bool StartWithShellExecuteEx(ProcessStartInfo startInfo)
        {
            ...
            {
                throw new InvalidOperationException("Can't start as user");
            }
            ...
            {
                throw new InvalidOperationException("StandardError Encoding Not Allowed");
            }

            if (startInfo.StandardOutputEncoding != null)
            {
                throw new InvalidOperationException("StandardOutput Encoding Not Allowed");
            }

            // can't set env vars with ShellExecuteEx...
            if (startInfo.environmentVariables != null)
            {
                throw new InvalidOperationException("Can't use environment variables");
            }
        ...
        public bool WaitForInputIdle(int milliseconds)
        {
            ...
            try
            {
                ...
                switch (ret)
                {
                    ...
                    default:
                        throw new InvalidOperationException("Input idle");
                }
            }
            finally
            {
        ...
        public void BeginOutputReadLine()
        {
            ...
            {
                throw new InvalidOperationException("Can't mix sync and async operations");
            }

            if (pendingOutputRead)
                throw new InvalidOperationException("Pending async operation");
            ...
            if (output == null)
            {
                if (standardOutput == null)
                {
                    throw new InvalidOperationException("Can't get standard output");
                }
        ...
        public void BeginErrorReadLine()
        {
            ...
            if (pendingErrorRead)
            {
                throw new InvalidOperationException("Pending asynchronous operation");
            }
            ...
            if (error == null)
            {
                if (standardError == null)
                {
                    throw new InvalidOperationException("Can't get standard error");
                }
