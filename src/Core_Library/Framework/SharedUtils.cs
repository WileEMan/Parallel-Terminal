// From reference source v4.6.1/System/services/monitoring/system/diagnostics/SharedUtils.cs
    ...
    internal static class SharedUtils
    {
        ...
        internal static void CheckEnvironment()
        {
            if (CurrentEnvironment == NonNtEnvironment)
                throw new PlatformNotSupportedException("Windows NT or newer is required");
        }

        internal static void CheckNtEnvironment()
        {
            if (CurrentEnvironment == NtEnvironment)
                throw new PlatformNotSupportedException("Windows 2000 or newer is required");
        }
        ...
        {
            System.Diagnostics.Debug.Assert(mutexOut == null, "You must pass in a null ref Mutex");
        ...
        internal static string GetLatestBuildDllDirectory(string machineName)
        {
            ...
            try
            {
                ...
                if (baseKey == null)
                    throw new InvalidOperationException("Missing registry key"); //, "HKEY_LOCAL_MACHINE", machineName));
