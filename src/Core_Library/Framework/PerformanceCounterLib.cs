// From reference source v4.6.1/System/services/monitoring/system/diagnostics/PerformanceCounterLib.cs
// And from reference source v4.6.1/System/services/monitoring/system/diagnostics/AlphabeticalEnumConverter.cs
// And from reference source v4.6.1/System/services/monitoring/system/diagnostics/PerformanceCounterType.cs
// And from reference source v4.6.1/System/services/monitoring/system/diagnostics/PerformanceCounterCategoryType.cs
// And from reference source v4.6.1/System/services/monitoring/system/diagnostics/InstanceData.cs
// And from reference source v4.6.1/System/services/monitoring/system/diagnostics/InstanceDataCollection.cs
// And from reference source v4.6.1/System/services/monitoring/system/diagnostics/InstanceDataCollectionCollection.cs
// And from reference source v4.6.1/System/services/monitoring/system/diagnostics/PerformanceCounterInstanceLifetime.cs
...
namespace wbSystem.Diagnostics
{
    ...
    internal class PerformanceCounterLib
    {
        ...
        private CategorySample GetCategorySample(string category)
        {
            ...
            if (dataRef == null)
                throw new InvalidOperationException("Can't read category");
        ...
        internal static string GetCounterHelp(string machine, string category, string counter)
        {
            ...
            if (!categoryExists)
                throw new InvalidOperationException("Missing category detail");
        ...
        private string GetCounterHelp(string category, string counter, ref bool categoryExists)
        {
            ...
            if (helpIndex == -1)
                throw new InvalidOperationException("Missing counter");
    ...
    internal class PerformanceMonitor
    {
        ...
        internal byte[] GetData(string item)
        {
            ...
            while (waitRetries > 0)
            {
                ...
                {
                    throw new InvalidOperationException("Counter data corrupt", e); // SR.GetString(SR.CounterDataCorrupt, perfDataKey.ToString()), e);
                }
            }
    ...
    internal class CategorySample
    {
        ...
        internal unsafe CategorySample(byte[] data, CategoryEntry entry, PerformanceCounterLib library)
        {
            ...
            fixed (byte* dataPtr = data)
            {
                ...
                if (!foundCategory)
                    throw new InvalidOperationException("Can't read category index");
    ...
    internal class CounterDefinitionSample
    {
        ...
        internal CounterSample GetInstanceValue(string instanceName)
        {
            ...
            if (!categorySample.InstanceNameTable.ContainsKey(instanceName))
            {
                ...
                if (!categorySample.InstanceNameTable.ContainsKey(instanceName))
                    throw new InvalidOperationException("Can't read instance: " + instanceName);    // SR.GetString(SR.CantReadInstance, instanceName));
            }
