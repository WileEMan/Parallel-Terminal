...
// From reference source v4.6.1/mscorlib/system/runtime/compilerservices/jithelpers.cs

namespace wbSystem.Runtime.CompilerServices
{
    //[FriendAccessAllowed]
...
// From reference source v4.6.1/mscorlib/system/buffer.cs
...
namespace wbSystem
{
    using wbSystem.Runtime.CompilerServices;
    ...
    public static class Buffer
    {
        ...
        public static byte GetByte(Array array, int index)
        {
            ...
            if (!IsPrimitiveTypeArray(array))
                throw new ArgumentException("Must be a primitive array", "array");
