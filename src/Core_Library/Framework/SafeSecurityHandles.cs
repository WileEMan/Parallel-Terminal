// From reference source v4.6.1/mscorlib/system/security/safesecurityhandles.cs
...
namespace wbMicrosoft.Win32.SafeHandles
{
    ...
    internal sealed class SafeLsaLogonProcessHandle : Microsoft.Win32.SafeHandles.SafeHandleZeroOrMinusOneIsInvalid
    {
...
#if WB_OMIT         // Omitting this one because there is a conflict with the version in SafeHandles.cs.  I'm not sure how this conflict survives in the .NET source itself, because it looks present there too.  But namespace conflict aside, that one has more functionality & is compatible.
    [System.Security.SecurityCritical]  // auto-generated
